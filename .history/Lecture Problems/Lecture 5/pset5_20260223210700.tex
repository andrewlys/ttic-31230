...
\[
\Pr(w_{t + 2} | w_{t}, w_{t + 1}) = \mathrm{softmax}_{w_{t + 2}} 0 = \mathrm{Unif}[W]
\]
Meaning that the model will randomly select a word from the vocabulary independently of the previous two words. 
\end{document}
